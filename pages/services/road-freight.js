...
import serviceInfo01 from '@/public/brand/service-road-info-01.jpg'
import serviceInfo02 from '@/public/brand/service-road-info-02.jpg'
import serviceStorage from '@/public/brand/service-04.png'

export default function RoadFreight() {
  const { t } = useTranslation(['common', 'road-freight'])
      ...
      <section className="service-detail-section">
        <div className="w-layout-blockcontainer container w-container">
          <div data-w-id="f50eba78-75c9-ab47-4869-fd427a409e12" style={{opacity: 0}} className="service-detail-hero-wrap">
            <h1 data-w-id="bcad01a5-ab09-5b58-0c42-99cf5fe8db5c" style={{opacity: 0}} className="heading-h2 text-white">{t('road-freight:page.title')}</h1>
            <img src="/brand/big-service-02.svg" loading="eager" style={{opacity: 0}} data-w-id="407d0a5f-2cba-e22a-be98-b0e96a15cd33" alt="Service Image" className="service-detail-image" />
          </div>
        </div>
      </section>
        ...
        <div className="w-layout-blockcontainer container w-container">
          <div className="w-layout-grid grid-service-info">
            <div id="w-node-_81d7f483-d870-be31-a398-cab606ea51c2-ad09b4e5">
              <div>
                <h2 data-w-id="5a582872-4b96-4b79-4811-0d2dcd269d52" style={{opacity: 0}} className="heading-h5">{t('road-freight:hero.heading')}</h2>
                <p data-w-id="be9e43a5-4fce-0a9f-b8c6-a4986c61be56" style={{opacity: 0}}>{t('road-freight:hero.desc')}</p>
                ...
                <h2 data-w-id="931a641f-a55c-b361-60fb-6edd2a6ad601" style={{opacity: 0}} className="heading-h5">{t('road-freight:included.title')}</h2>
                <p data-w-id="ca642dbd-33fc-4133-7abc-6e0e785619b4" style={{opacity: 0}}>{t('road-freight:included.desc')}</p>
              </div>
              <div className="service-feature-list">
                <div data-w-id="75c80190-f89e-3138-6153-fa5c64fbb874" style={{opacity: 0}}>
                  <h2 className="heading-h5">{t('road-freight:feature1.title')}</h2>
                  <p>{t('road-freight:feature1.desc')}</p>
                </div>
                <div data-w-id="c16f76fb-6140-547a-0720-176fbb00f924" style={{opacity: 0}}>
                  <h2 className="heading-h5">{t('road-freight:feature2.title')}</h2>
                  <p>{t('road-freight:feature2.desc')}</p>
                </div>
                <div data-w-id="13e67113-896c-802c-30b2-14b31e044264" style={{opacity: 0}}>
                  <h2 className="heading-h5">{t('road-freight:feature3.title')}</h2>
                  <p>{t('road-freight:feature3.desc')}</p>
                </div>
              </div>
              <div className="w-layout-grid grid-why-choose-us">
                ...
                <div id="w-node-e68b6a9f-55c2-9351-2506-62b164b07f25-ad09b4e5">
                  <h2 data-w-id="96fecc7f-1fe9-db1c-f759-48e1fc50e623" style={{opacity: 0}} className="heading-h5">{t('road-freight:why.title')}</h2>
                  <p data-w-id="96fecc7f-1fe9-db1c-f759-48e1fc50e625" style={{opacity: 0}}>{t('road-freight:why.desc')}</p>
                  <div data-w-id="68ae620d-8387-df3c-8913-8517c8c062cb" style={{opacity: 0}} className="why-choose-us-list">
                    <div className="why-choose-us-list-item"><img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" /><div>{t('road-freight:why.bullet1')}</div></div>
                    <div className="why-choose-us-list-item"><img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" /><div>{t('road-freight:why.bullet2')}</div></div>
                    <div className="why-choose-us-list-item"><img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" /><div>{t('road-freight:why.bullet3')}</div></div>
                    <div className="why-choose-us-list-item"><img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" /><div>{t('road-freight:why.bullet4')}</div></div>
                    <div className="why-choose-us-list-item"><img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" /><div>{t('road-freight:why.bullet5')}</div></div>
                  </div>
                </div>
              </div>
            </div>
...
export async function getStaticProps({ locale }) {
  return {
    props: {
      ...(await serverSideTranslations(locale, ['common', 'road-freight'])),
    },
  }
}
