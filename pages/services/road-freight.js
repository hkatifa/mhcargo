      ...
      <section className="service-detail-section">
        <div className="w-layout-blockcontainer container w-container">
          <div data-w-id="f50eba78-75c9-ab47-4869-fd427a409e12" style={{opacity: 0}} className="service-detail-hero-wrap">
            <h1 data-w-id="bcad01a5-ab09-5b58-0c42-99cf5fe8db5c" style={{opacity: 0}} className="heading-h2 text-white">Road Freight</h1>
            ...
            <div id="w-node-_81d7f483-d870-be31-a398-cab606ea51c2-ad09b4e5">
              ...
              <div className="service-feature-list">
                <div data-w-id="75c80190-f89e-3138-6153-fa5c64fbb874" style={{opacity: 0}}>
                  <h2 className="heading-h5">FTL (Full Truck Load):</h2>
                  <p>Dedicated trucks for your exclusive use with direct routes from origin to destination. Ideal for large shipments requiring maximum speed and security.</p>
                </div>
                <div data-w-id="c16f76fb-6140-547a-0720-176fbb00f924" style={{opacity: 0}}>
                  <h2 className="heading-h5">LTL / Groupage (Less than Truck Load):</h2>
                  <p>Cost-effective shared truck space for smaller shipments. We consolidate cargo to optimize your transport costs without compromising on reliability.</p>
                </div>
                <div data-w-id="13e67113-896c-802c-30b2-14b31e044264" style={{opacity: 0}}>
                  <h2 className="heading-h5">Import & Export Road Services:</h2>
                  <p>Daily departures for Moroccan exports to European markets and reliable inbound logistics for raw materials and finished goods — with controlled flow management to keep your supply chain moving.</p>
                </div>
              </div>
              <div className="w-layout-grid grid-why-choose-us">
                ...
                <div id="w-node-e68b6a9f-55c2-9351-2506-62b164b07f25-ad09b4e5">
                  ...
                  <div data-w-id="68ae620d-8387-df3c-8913-8517c8c062cb" style={{opacity: 0}} className="why-choose-us-list">
                    ...
                    <div className="why-choose-us-list-item">
                      <img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" />
                      <div>Real-time communication with drivers and partners</div>
                    </div>
                    <div className="why-choose-us-list-item">
                      <img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" />
                      <div>Reliable scheduling and guaranteed departure dates</div>
                    </div>
                    <div className="why-choose-us-list-item">
                      <img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" />
                      <div>FTL and LTL for all cargo sizes</div>
                    </div>
                  </div>
                </div>
              </div>
