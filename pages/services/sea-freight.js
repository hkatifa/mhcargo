...
export default function SeaFreight() {
  ...
  return (
    <Layout
      title="Sea Freight | MH Cargo"
      description={t('seo.sea-freight.description')}
      currentPage="/services/sea-freight"
      ...
      <section className="service-detail-section">
        <div className="w-layout-blockcontainer container w-container">
          <div data-w-id="f50eba78-75c9-ab47-4869-fd427a409e12" style={{opacity: 0}} className="service-detail-hero-wrap">
            <h1 data-w-id="bcad01a5-ab09-5b58-0c42-99cf5fe8db5c" style={{opacity: 0}} className="heading-h2 text-white">{t('sea-freight:page.title')}</h1>
            ...
            <div id="w-node-_81d7f483-d870-be31-a398-cab606ea51c2-ad09b4e5">
              ...
              <div className="service-feature-list">
                <div data-w-id="75c80190-f89e-3138-6153-fa5c64fbb874" style={{opacity: 0}}>
                  <h2 className="heading-h5">{t('sea-freight:feature1.title')}</h2>
                  <p>{t('sea-freight:feature1.desc')}</p>
                </div>
                <div data-w-id="c16f76fb-6140-547a-0720-176fbb00f924" style={{opacity: 0}}>
                  <h2 className="heading-h5">{t('sea-freight:feature2.title')}</h2>
                  <p>{t('sea-freight:feature2.desc')}</p>
                </div>
                <div data-w-id="13e67113-896c-802c-30b2-14b31e044264" style={{opacity: 0}}>
                  <h2 className="heading-h5">{t('sea-freight:feature3.title')}</h2>
                  <p>{t('sea-freight:feature3.desc')}</p>
                </div>
              </div>
              <div className="w-layout-grid grid-why-choose-us">
                ...
                <div id="w-node-e68b6a9f-55c2-9351-2506-62b164b07f25-ad09b4e5">
                  ...
                  <p data-w-id="96fecc7f-1fe9-db1c-f759-48e1fc50e625" style={{opacity: 0}}>{t('sea-freight:why.desc')}</p>
                  <div data-w-id="68ae620d-8387-df3c-8913-8517c8c062cb" style={{opacity: 0}} className="why-choose-us-list">
                    <div className="why-choose-us-list-item"><img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" /><div>{t('sea-freight:why.bullet1')}</div></div>
                    <div className="why-choose-us-list-item"><img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" /><div>{t('sea-freight:why.bullet2')}</div></div>
                    <div className="why-choose-us-list-item"><img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" /><div>{t('sea-freight:why.bullet3')}</div></div>
                    <div className="why-choose-us-list-item"><img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" /><div>{t('sea-freight:why.bullet4')}</div></div>
                    <div className="why-choose-us-list-item"><img src="/brand/dark-list-icon.svg" loading="eager" alt="" className="why-choose-us-icon" /><div>{t('sea-freight:why.bullet5')}</div></div>
                  </div>
                </div>
              </div>
            </div>
...
export async function getStaticProps({ locale }) {
  return {
    props: {
      ...(await serverSideTranslations(locale, ['common', 'sea-freight'])),
    },
  }
}
